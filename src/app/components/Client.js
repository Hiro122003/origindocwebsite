    ...
    <div className="mt-24 rounded-[50px] bg-gray-950 py-20">
      <Container>
        <FadeIn className="flex items-center gap-x-8">
          <h2 className="text-center text-white text-sm font-semibold tracking-wide">
            こちらの企業も導入してます。
          </h2>
        ...
        <FadeInStagger faster>
          <ul className="mt-10 grid grid-cols-2 gap-x-8 lg:grid-cols-4 gap-10 place-items-center">
